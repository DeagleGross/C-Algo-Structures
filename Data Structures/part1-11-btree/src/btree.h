...
#pragma pack(pop)
    ...
    public: 
         ...
         */
        void insertNonFull(const Byte* toInsert);
...
public:
     ...
     *
     */
    void insert(const Byte* toInsert);
     ...
     */
    Byte* search(const Byte* toInsert);
     ...
     */
    int searchAll(const Byte* toInsert, std::list<Byte*>& keys);
     ...
     *  \returns число найденных элементов
     */
    int searchAllFromPosition(PageWrapper* p, const Byte* toInsert, std::list<Byte*>& keys);
